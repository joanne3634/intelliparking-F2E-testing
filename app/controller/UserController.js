...
exports = module.exports = function(app) {
    ...
    app.group('/users', function(router){
        ...
        router.post('/signup', function*(next){
            var self = this, dustFile = 'users/v2/signup.dust', dian13User , eSkyGoUser;
            try {
                ...
                var alias = {type: "username", alias: params.username, provider: "eskygo", password: app._crypter.hash(params.password) };
                ...
                try {
                    ...
                    yield userServ.post(`/users/`+eSkyGoUser.id+`/roles`, {roles: ["13dian"]});
                } catch(e) {
